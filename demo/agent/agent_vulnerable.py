...
async def main():
    print("[agent] mode: NO PROTECTION")
    ...
    async with httpx.AsyncClient() as client:
        ...
        print()
        print(f"[agent] description says $0.01 -- agent trusts it, pays blindly")
        print()
        ...
        print(f"[agent] DRAINED: paid ${raw_amount / 1_000_000:.2f}, description said $0.01")
